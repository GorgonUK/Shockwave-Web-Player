use crate::{
    ...
    player::{
        bitmap::{
            bitmap::{get_system_default_palette, Bitmap, BuiltInPalette, PaletteRef},
            drawing::CopyPixelsParams,
        },
        cast_lib::CastMemberRef,
        font::{
            get_glyph_preference, get_text_index_at_pos, measure_text, DrawTextParams,
            GlyphPreference,
        },
            ...
            "regpoint" => borrow_member_mut(
                ...
                |player| {
                    ...
                    if list.len() >= 2 {
                        ...
                        Err(ScriptError::new(
                            "regPoint requires a point with 2 elements".to_string(),
                        ))
                    }
                },
                |cast_member, value| {
