use crate::{
    ...
    player::{
        cast_lib::CastMemberRef, cast_member::ButtonType,
        handlers::datum_handlers::cast_member_ref::borrow_member_mut, DirPlayer, ScriptError,
    },
};
    ...
    pub fn set_prop(
        ...
        match prop.as_str() {
            "text" => borrow_member_mut(
                ...
                |cast_member, value| {
                    cast_member.member_type.as_button_mut().unwrap().field.text =
